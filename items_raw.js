...
/*	"Armor, +1, +2, or +3": {
	...
	"Crystal Ball of Mind Reading": {
		"content": [
			...
			"The *crystal ball of mind reading* grants you additional abilities:",
	...
	"Crystal Ball of Telepathy": {
		"content": [
			"*Wondrous item, legendary (requires attunement)*",
			"The typical *crystal ball*, a very rare item, is about 6 inches in diameter. While touching it, you can cast the *scrying* spell (save DC 17) with it.",
			"The *Crystal Ball of Telepathy* grants you additional abilities:",
	...
	"Crystal Ball of True Seeing": {
		"content": [
			"*Wondrous item, legendary (requires attunement)*",
			"The typical *crystal ball*, a very rare item, is about 6 inches in diameter. While touching it, you can cast the *scrying* spell (save DC 17) with it.",
			"The *Crystal Ball of True Seeing* grants you additional abilities:",
...
/*	"Mithral Armor": {
	...
	"Potion of Hill Giant Strength": {
		"content": [
			"*Potion, uncommon*",
			"When you drink this potion, your Strength score is set to 21 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.",
	...
	"Potion of Frost Giant Strength": {
		"content": [
			"*Potion, rare*",
			"When you drink this potion, your Strength score is set to 23 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.",
	...
	"Potion of Fire Giant Strength": {
		"content": [
			"*Potion, rare*",
			"When you drink this potion, your Strength score is set to 25 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.",
			"This potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type.",
		],
	},
	"Potion of Cloud Giant Strength": {
		"content": [
			"*Potion, very rare*",
			"When you drink this potion, your Strength score is set to 27 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.",
			"This potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type.",
		],
	},
	"Potion of Storm Giant Strength": {
		"content": [
			"*Potion, legendary*",
			"When you drink this potion, your Strength score is set to 29 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score.",
			"This potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type.",
		],
	},
	"Potion of Growth": {
